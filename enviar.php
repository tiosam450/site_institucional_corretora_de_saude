...
// Mudar Aqui o e-mail
$email_envio = "camilla@envidacorretora.com.br"; // E-mail do site (ex: contato@seusite.com)
$email_pass = ""; // Senha do e-mail

$site_name = "Envida Corretora"; // Nome do Site
$site_url = "http://envidacorretora.com.br/"; // URL do Site

$host_smtp = "smtplw.com.br"; // HOST SMTP Ex: smtp.domain.com.br
